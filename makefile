assembler: assembler.o macro.o utils.o firstpass.o improve.o secondpass.o openentry.o openextern.o validate.o output.o
	gcc -g -ansi -pedantic -Wall assembler.o macro.o utils.o firstpass.o improve.o secondpass.o openentry.o openextern.o  validate.o output.o -o assembler
